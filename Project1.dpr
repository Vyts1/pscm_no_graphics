...
begin
  ...
  iniVar.dpmin_abs := 20;
  iniVar.dpmax_abs := 20;
  iniVar.temp_patic_min := 935;
  iniVar.temp_patic_max := 935;
  iniVar.velos_min := 800;
  iniVar.velos_max := 800;
  iniVar.temp_base := 400;
  iniVar.fild_size_X := 4000;
  iniVar.fild_size_Y := 4000;
  ...
  iniVar.a4 := 2;
  iniVar.a5 := 2;
  iniVar.kol_spletov := round(10000);
  iniVar.coat := 30;
  iniVar.srez_interval := round(40);
  iniVar.VolCon := 0.05;
  iniVar.incmat := 51; // материал включений
  iniVar.basemat := 16; // материал подложки
  iniVar.modefild := 0; // форма подложки
  iniVar.partmat := 1; // материал частицы
  iniVar.sposob_vvoda := 0;
  iniVar.tip_materiala := 0; // формула
  iniVar.is_col := true; // ограничение по толщине покрытия
  ...
  iniVar.part_class.m_nId := 2;
  iniVar.part_class.m_Material := 'Al';
  iniVar.part_class.m_ROms := 2500;
  iniVar.part_class.m_ROml := 2385;
  iniVar.part_class.m_CPms := 1194;
  iniVar.part_class.m_CPml := 1080;
  iniVar.part_class.m_Lms := 220;
  iniVar.part_class.m_Lml := 94;
  iniVar.part_class.m_Tm := 933;
  iniVar.part_class.m_TBoil := 0;
  iniVar.part_class.m_Lm := 311341;
  iniVar.part_class.m_MUml := 0.00125;
  iniVar.part_class.m_SIGml := 0.914;
  iniVar.part_class.m_LBoil := 0;
  iniVar.part_class.m_AW := 26.98;
  ...
  case iniVar.tip_materiala of
         0 :
             begin
               ...
               advcalculator_metal (false, iniVar.dpmax_abs/1000000, iniVar.temp_patic_max, iniVar.temp_base, absolut_max_velos, iniVar.part_class, iniVar.sub_class, iniVar.h_max, iniVar.Ds_max_abs, scen, h, -2);
               ...
               advcalculator_metal (true,  iniVar.dpmax_abs/1000000, iniVar.temp_patic_max, iniVar.temp_base, absolut_max_velos, iniVar.part_class, iniVar.sub_class, iniVar.h_max, iniVar.Ds_max_abs, scen, h, -2);
               if FloatIsNorm(iniVar.Ds_max_abs) AND FloatIsNorm(iniVar.h_max)
